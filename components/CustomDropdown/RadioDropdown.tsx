...
type P = {
  ...
  textfield?: boolean;
  /** Show dropdown values alignment */
    ...
    <Stack>
      <Stack className="relative">
        ...
        <Card
          elevation={0}
          radius="md"
          className={`absolute flex flex-col border dark:border-surfaceDark-dark border-surface-dark top-10 ${
            alignment === 'right' ? 'right-0' : 'left-0'
          } z-[999999991] ${
            textfield ? 'min-w-52' : 'min-w-44'
          }  w-full  p-3 pb-2 ${dropdownVisibilityClass}`}
